  ...
  return (<>
    <div className="container">
      ...
      <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
        ...
        of <a href="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &rdquo;the Company&rdquo;, &rdquo;We&rdquo;, &rdquo;Us&rdquo; or &rdquo;Our&rdquo; in this Agreement) refers
            to Deej Potter Designs.</p>
        </li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a
          party, where &rdquo;control&rdquo; means ownership of 50% or more of the shares, equity interest or other securities
        ...
        <li><strong>Website</strong> refers to Deej Potter Designs, accessible from https://www.deejpotterdesigns.com/
        </li>
      ...
      <p>Cookies can be &rdquo;Persistent&rdquo; or &rdquo;Session&rdquo; Cookies. Persistent Cookies remain on your personal computer or mobile
      ...
      <ul>
        ...
        <li><strong>With other users:</strong> when You share personal information or otherwise interact in the public
          areas with other users, such information may be viewed by all users and may be publicly distributed outside. If
      ...
      <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective
        and update the &rdquo;Last updated&rdquo; date at the top of this Privacy Policy.</p>
