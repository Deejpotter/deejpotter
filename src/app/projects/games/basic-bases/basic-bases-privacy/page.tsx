...
export default function BasicBasesPrivacy(): ReactElement {
  return (
    <>
      ...
      <p>
        Deejpotter built the Basic Bases game as free game. This SERVICE is
        provided by Deejpotter at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Basic Bases unless
      ...
      <p>
        This Service does not use these “cookies” explicitly. However, the game
      ...
      <p>
        ...
        hesitate to contact me at deejpotter@gmail.com.
      </p>
    </>
  );
}
