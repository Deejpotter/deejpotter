...
export default function BasicBasesPrivacy(): ReactElement {
  return (<>
    ...
    Deejpotter built the Basic Bases game as
    free game. This SERVICE is provided by
    Deejpotter at no cost and is intended for
    use as is.
  </p> <p>
    ...
    Basic Bases unless otherwise defined in this Privacy
    Policy.
