  ...
  if (!hasClerk) {
    return (
      <main className="mx-auto max-w-2xl px-4 py-20 text-center">
        <h1 className="text-3xl font-extrabold mb-4">Shop Products</h1>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 sm:py-12 lg:py-16">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight mt-1">Shop Products</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-2">Manage digital and service products.</p>
      </div>
      <ProductsAdmin />
    </div>
  );
