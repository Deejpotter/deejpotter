    ...
    <>
      ...
      <ul>
        <li>
          ...
          &rdquo;control&rdquo; means ownership of 50% or more of the shares,
        ...
        <li>
          ...
          &rdquo;Our&rdquo; in this Agreement) refers to Deej Potter Designs.
        </li>
        <li>
        ...
        <li>
          ...
          &rdquo;Terms&rdquo;) mean these Terms and Conditions that form the
          entire agreement between You and the Company regarding the use of the
          Service. This Terms and Conditions agreement as been created with the
          help of{" "}
        ...
        <li>
          <strong>Website</strong> refers to Deej Potter Designs, accessible
          from www.deejpotterdesigns.com
        </li>
        <li>
      ...
      <p>
        The Service is provided to You &rdquo;AS IS&rdquo; and &rdquo;AS
        AVAILABLE&rdquo; and with all faults and defects without warranty of any
