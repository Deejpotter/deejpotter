...
- **Testing:** Use Vitest with React Testing Library for unit and component tests, and Playwright for E2E. This project does not use Jest. Write tests for all critical logic and components. Async server components are tested by awaiting them first: `render(await Page())`.
