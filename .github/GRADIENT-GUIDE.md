...
- **Motion:** transitions are 150–200ms, and hover lifts and animations are turned off for `prefers-reduced-motion`.
...
2. Don't hand-write vendor prefixes. Autoprefixer adds them, and stylelint rejects them.
